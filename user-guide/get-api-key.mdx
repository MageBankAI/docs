...
<Steps>
    <Step title="Visit Mage Dashboard">
        Navigate to the [Mage Dashboard](https://www.mage.ai/dashboard/)
        <Frame>
            <img src="/images/get-api-key/dashboard-login.png" alt="Mage Dashboard" />
        </Frame>
    </Step>
    ...
    <Step title="Navigate to Integrate Agent section">
        Once logged in, go to the [Integrate Agent](https://www.Mage.ai/dashboard/integrate-agent) section from the sidebar menu.
        <Frame>
