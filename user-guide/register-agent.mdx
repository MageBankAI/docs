...
When you create an agent, you allocate funds from your main wallet to the agent's wallet. This amount is deducted immediately and becomes available for the agent to use within its configured limits.
