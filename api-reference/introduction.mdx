...
<Note>
  To get your API key, visit the [Mage Dashboard](https://www.Mage.ai/dashboard) and navigate to the "Integrate Agent" section.
</Note>
...
If you encounter any issues or have questions about the API, reach out to our support team at [contact@Mage.ai](mailto:contact@Mage.ai).