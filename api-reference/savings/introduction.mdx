...
The Savings API allows you to deposit funds into interest-bearing accounts, withdraw funds with earned interest, check current interest rates, and monitor investment performance. These endpoints enable you to optimize idle funds by earning competitive interest rates on your USDC holdings.
...
- **Interest Rate**: Annual percentage yield applied to the investment
...
1. **Current Rate**: Interest rate is set at the platform level and can be checked via the [Get Interest Rate](/api-reference/savings/get-interest-rate) endpoint
