...
<Note>
**Investment History**: Retrieve a complete history of all investments (both active and completed) for a specific agent with real-time valuation of active investments.
</Note>
