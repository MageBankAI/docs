...
<ParamField body="userid" type="string" required>
  ID of the user creating the agent (UUID format)
</ParamField>
...
<ParamField body="requireapprovalaboveamount" type="number" format="decimal(10,2)">
  Transactions above this amount require approval (stored with 2 decimal precision)
</ParamField>

<ParamField body="tags" type="array">
  Categories or labels to assign to the agent (stored as text[])
</ParamField>

## Response

<ResponseField name="id" type="string">
  Unique agent identifier in short ID format (derived from UUID)
</ResponseField>
...
<ResponseField name="balance" type="string">
  Initial balance of the agent's wallet (string representation of numeric value)
</ResponseField>
...
<ResponseField name="paymentRules" type="object">
  <Expandable title="properties">
    ...
    <ResponseField name="requireApprovalAboveAmount" type="number" format="decimal(10,2)">
...
<ResponseField name="tags" type="array">
  Categories or labels assigned to the agent (text[])
</ResponseField>

<ResponseField name="created" type="string">
  Timestamp when the agent was created (with timezone)
</ResponseField>
...
- The `dailylimit` and `transactionlimit` are stored as integers.
- The `requireapprovalaboveamount` is stored with 2 decimal places precision.
