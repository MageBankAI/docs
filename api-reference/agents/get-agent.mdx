...
- The agent ID can be in the short format (e.g., `agent_k77NTwxp2Ym3JCmVsKtXQA`) or UUID format.
- Balance is returned as a string to preserve precision for financial calculations.
- Created timestamp is in ISO 8601 format with timezone information.