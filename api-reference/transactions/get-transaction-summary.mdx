...
Provides a summary of financial activity within the specified date range, including total amounts earned (deposits, interest) and spent (withdrawals, payments).
...
- The maximum date range is 366 days (1 year). For longer periods, make multiple requests.
...
- Interest calculations include interest accrued during the period, even if not yet withdrawn.