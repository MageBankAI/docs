...
<Note>
  <span className="font-bold">DEVELOPER SUPPORT:</span> Our developer team is available to assist with integration questions specific to your MCP or A2A implementation. Contact us at <a href="mailto:developers@magebank.ai" className="text-primary font-medium">developers@magebank.ai</a>.
</Note>