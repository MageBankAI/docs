...
<CardGroup cols={2}>
    <Card title="Users API" icon="user" href="/api-reference/users/introduction">
    ...
    <Card title="Transactions API" icon="exchange" href="/api-reference/transactions/introduction">
